...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fontLbl.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        fontLbl.setText("Change font size");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scrollbar, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
                .addComponent(fontLbl)
    ...
    private void scrollbarAdjustmentValueChanged(java.awt.event.AdjustmentEvent evt) {//GEN-FIRST:event_scrollbarAdjustmentValueChanged
        ...
        fontLbl.setFont(new Font(fontLbl.getFont().getName(), Font.BOLD, scrollbar.getValue()));
